...
class PPStrategy(BaseStrategy):
    ...
    def check_condition(self,futureSymbol):
        ...
        if ltp[-2] < top_cpr + 10 and (top_cpr + (R1 - top_cpr) * 0.2) >= ltp[-1] > top_cpr and ltp[-2] < ltp[-1]:
        ...
        elif ltp[-2] < R1 + 10 and R1 + (R2 - R1) * 0.2 >= ltp[-1] > R1 and ltp[-2] < \
                ltp[-1]:
            option_type = "CE"
        ...
        elif ltp[-2] < R2 + 10 and R2 + (R3 - R2) * 0.2 >= ltp[-1] > R2 and ltp[-2] < \
                ltp[-1]:
            option_type = "CE"
        ...
        elif ltp[-2] < R3 + 10 and R3 + (R4 - R3) * 0.2 >= ltp[-1] > R3 and ltp[-2] < \
                ltp[-1]:
            option_type = "CE"
        ...
        elif ltp[-2] < R4 + 10 and R4 + (R4 - R3) * 0.2 >= ltp[-1] > R4 and ltp[-2] < \
                ltp[-1]:
            option_type = "CE"
        ...
        elif ltp[-2] < S1 + 10 and S1 + (bottom_cpr - S1) * 0.2 >= ltp[-1] > S1 and ohlcv[
            'open'] < ltp[-1]:
            option_type = "CE"
        ...
        elif ltp[-2] < S2 + 10 and S2 + (S1 - S2) * 0.2 >= ltp[-1] > S2 and ltp[-2] < \
                ltp[-1]:
            option_type = "CE"
        ...
        elif ltp[-2] < S3 + 10 and S3 + (S2 - S3) * 0.2 >= ltp[-1] > S3 and ltp[-2] < \
                ltp[-1]:
            option_type = "CE"
        ...
        elif ltp[-2] < S4 + 10 and S4 + (S3 - S4) * 0.2 >= ltp[-1] > S4 and ltp[-2] < \
                ltp[-1]:
            option_type = "CE"
        ...
        elif ltp[-2] > bottom_cpr - 10 and (bottom_cpr - (bottom_cpr - S1) * 0.20) <= ohlcv[
            'close'] < bottom_cpr and ltp[-2] > ltp[-1]:
            option_type = "PE"
        ...
        elif ltp[-2] > S1 - 10 and S1 - (S1 - S2) * 0.2 <= ltp[-1] < S1 and ltp[-2] > \
                ltp[-1]:
            option_type = "PE"
        ...
        elif ltp[-2] > S2 - 10 and S2 - (S2 - S3) * 0.2 <= ltp[-1] < S2 and ltp[-2] > \
                ltp[-1]:
            option_type = "PE"
        ...
        elif ltp[-2] > S3 - 10 and S3 - (S3 - S4) * 0.2 <= ltp[-1] < S3 and ltp[-2] > \
                ltp[-1]:
            option_type = "PE"
        ...
        elif ltp[-2] > R1 - 10 and R1 - (R1 - top_cpr) * 0.2 <= ltp[-1] < R1 and ltp[-2] > ltp[-1]:
            option_type = "PE"
        ...
        elif ltp[-2] > R2 - 10 and R2 - (R2 - R1) * 0.2 <= ltp[-1] < R2 and ltp[-2] > \
                ltp[-1]:
            option_type = "PE"
        ...
        elif ltp[-2] > R3 - 10 and R3 - (R3 - R2) * 0.2 <= ltp[-1] < R3 and ltp[-2] > \
                ltp[-1]:
            option_type = "PE"
        ...
        ATMSymbol = Utils.prepareWeeklyOptionsSymbol("BANKNIFTY", ATMStrike + self.atm_add, option_type)
